          ...
          >
            <Styled.MenuLayout>
              <atoms.p>
                ...
                świecie, w którym piękno i miłość to synonimy życia. Śmierć jawi
                się jako coś w ścisłym sensie nie do pomyślenia czy wyobrażenia,
                nawet jeśli bohaterki muszą się z nią – zresztą tylko pozornie –
                skonfrontować w indywidualnym doświadczeniu. W Szczęściu (Le
                bonheur, 1965) śmierć (być może samobójcza) jednej z głównych
                bohaterek to jedyny moment, w którym celowo sztuczna, nadmiernie
                pogodna i beztroska tonacja filmu zostaje na krótką chwilę
                zawieszona – widzimy zwłoki młodej, pięknej kobiety, której
                odejście pozwala zrealizować męską fantazję o niemal bezbolesnym
                zastąpieniu jednej kobiety przez inną, żony przez kochankę.
                Umieranie nie jest tutaj zatem problemem, co najwyżej pozbawia
                problemu tych, którzy pozostali przy życiu. Nie dowiadujemy się,
                co kierowało bohaterką, a jej walka o życie zredukowana zostaje
                do mikroujęć pokazujących ją, jak tonąc, chwyta się
                zwieszających się nad wodą gałęzi. To jedynie drobny epizod,
                mocny, choć tylko pozorny zwrot dramaturgiczny, który nie
                narusza w istocie ani ciągłości opowiadania, ani harmonii
                otaczającej rzeczywistości – i dlatego jest skandalem.
              </atoms.p>
            </Styled.MenuLayout>
          </Styled.MenuContet>
        )}
