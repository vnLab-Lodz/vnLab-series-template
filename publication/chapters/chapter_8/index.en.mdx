...
```footnotes
{{^1}}:Michel Foucault, *The Birth of The Clinic: An Archaeology of Medical Perception* (New York: Random House, 1975).
{{^2}}:For more on the “monster’s tail” see: Ariella Azoulay and Adi Ophir, *This Regime Which Is Not One* (Stanford: Stanford University Press, 2012).
```