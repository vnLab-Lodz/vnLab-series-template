...
<TitleSlide title="Wojciech Wilczyk: Photographs" />
...
<SplitSlide>
  ...
  />
  <TextSlide>
  <Quote>I would like to emphasize the fact that I have never been keen to create projects “to be watched with pleasure after years”.</Quote>
  </TextSlide>
</SplitSlide>
...
<TextSlide>
<Quote>Working on the Other City, we are making an attempt to photograph, not only the area of a former ghetto and the earlier Jewish quarter, but also traffic routes (or the traces of the ones long gone), and places important for the tragic history of the district, such as the locations of gates and walls, or the culverts connecting the small and big ghetto (such as the footbridge on Chłodna Street).</Quote>
</TextSlide>
