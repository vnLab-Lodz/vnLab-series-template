...
**WW:** Krzysztof Jurecki, who used this words while reviewing *There’s No Such Thing as an Innocent Eye*, did not mean a historical style, but the style of individual expression. His article features the names of photographers whom he considers to have such individual style. 
...
**IK: *There’s No Such Thing as an Innocent Eye* finds its continuation in another project based on the recognition of memory traces in the contemporary topography. Could you present it before we open the discussion with the audience?**
