...
```footnotes
{{^1}}:Jonas Ekeberg and Harald Østgaard Lund, *80 millioner bilder. Norsk kulturhistorisk fotografi 1855–2005*, (Oslo: Forlaget Press, 2008).
{{^2}}:Peter Larsen and Sigrid Lien, _Norsk fotohistorie. Frå daguerreotypi til digitalisering_, Oslo 2007.
{{^3}}:http://www.nb.no/pm/index.php accessed June 20, 2011; the index is a tool, built mainly on the research of photo historical institutions connected to museums, archives and libraries. Most of the photographers within the DEXTRA Photo collection are represented in the index, but with little contextual information. The ongoing research conducted in the collection will obviously change that situation.,
{{^4}}:http://www.ssb.no/histstat/sos/sos_077.pdf](http://www.ssb.no/histstat/sos/sos_077.pdf), accessed June 13, 2011.
{{^5}}:Espen Johnsen (ed.) _Brytninger. Norsk Arkitektur 1945–65_, Exhibition catalogue National Museum for Art, Architecture and Design, Oslo 2010. _80 millioner bilder_, p. 352-257.
{{^6}}:Tone Rasch, “Making Clothes Desirable, Making Fashion Visible – Images from Sohlberg Foto in the late 1960s”, in Joanne Turner (ed.) *Images in Time*, Bath, to be published in September 2011. Tone Rasch, “Striving for the Stars” in internet exhibition *Sweet Sixties*, http://www.fotorejestr.net/teknisk-museum-331 20.06.2010.
{{^7}}:Larsen and Lien, 2007, pp. 110-116.
{{^8}}:Oslo Kamera Klubb’s main archive is at Preus Museum, Horten.
{{^9}}:Thomas Michael Gunther, “The Spread of the Photography” in Michel Frizot (ed.), _A new history of photography_, Köln 1998, pp. 550-580.
{{^10}}:The number of Norwegian museums in Digitaltmuseum in June 2011.
{{^11}}:See note 5.
{{^12}}:Karolina Lewandowska and Karolina Puchala-Rojek, _Fotorejestr_, Warsaw 2011.
```